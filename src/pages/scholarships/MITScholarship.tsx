...
const MITScholarship = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      <Helmet>
        <title>MIT Scholarship Program | Complete Guide & Application</title>
        <meta name="description" content="Comprehensive guide to MIT scholarship programs and financial aid. Learn about eligibility, benefits, and application process." />
        <meta name="keywords" content="MIT scholarship, Massachusetts Institute of Technology, USA education, STEM scholarship" />
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="max-w-4xl text-white">
            ...
            <p className="text-lg sm:text-xl mb-6 opacity-90">
              Need-based financial aid for innovative minds
            </p>
              ...
              <div className="text-gray-300 space-y-8">
                <div className="bg-orange-500 bg-opacity-10 border-l-4 border-orange-500 p-6 rounded-r-lg">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-300">
                    <li>Families earning under $90,000 pay nothing</li>
                    <li>100% of demonstrated financial need met</li>
                    <li>No loans in financial aid packages</li>
                    <li>Average need-based scholarship: over $53,000</li>
                ...
                <div>
                  ...
                  <p className="text-lg leading-relaxed mb-6">
                    MIT is committed to ensuring that the most talented students can attend regardless of their financial circumstances. The Institute meets 100% of demonstrated financial need for all admitted students through grants, scholarships, and work-study opportunities.
                  </p>
                </div>
                ...
                <div className="border-t border-gray-700 pt-8">
                  ...
                  <p className="text-lg leading-relaxed mb-6">
                    MIT's comprehensive financial aid program makes world-class STEM education accessible. Our experts can help you navigate the application process and maximize your financial aid opportunities.
                  </p>
                  <Button 
